...
var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=hAzUG1kNyCQotsbFDUbozNHAA3eGGibO&q=80s&limit=10";
...
$(document).on("click", "button", function () {
    ...
    $("#eighties").html(" ");
    queryURL = "https://api.giphy.com/v1/gifs/search?q=" + gifValue + "&api_key=hAzUG1kNyCQotsbFDUbozNHAA3eGGibO&q=80s&limit=10";
